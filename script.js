			...
			$.each(data.items, function(key, value) {
				...
				if (typeof value.object.attachments != 'undefined') {
					if (value.object.attachments[0].objectType == 'photo') {
						...
						slide += '<div style="height: 261px;' + attachment + '"></div><div class="googleplus-content" style="height: 113px; overflow-x: hidden; padding: 5px;"><p>' + value.object.content + '</p></div>';
						...
						slide += attachment + '<div class="googleplus-content" style="height: 110px; overflow-x: hidden; padding: 5px;"><p>' + value.object.content + '</p></div>';
					} else {
						var attachment = '<h2><a href="' + value.object.attachments[0].url + '">' + value.object.attachments[0].displayName + '</a></h2>';
						slide += attachment + '<div class="googleplus-content" style="height: 335px; overflow-x: hidden;"><p>' + value.object.content + '</p></div>';
					}
				} else {
